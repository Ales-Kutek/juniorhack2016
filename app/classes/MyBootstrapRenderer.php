 ...
 */
class MyBootstrapRenderer extends Nette\Object implements Nette\Forms\IFormRenderer
{
...
//        $this->template->setFile(__DIR__ . '/@form.latte');
        ...
        if ($mode === NULL) {
            ...
            $this->template->setFile(APP_DIR.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'app'.DIRECTORY_SEPARATOR.'presenters'.DIRECTORY_SEPARATOR.'templates'.DIRECTORY_SEPARATOR.'@parts.latte');
